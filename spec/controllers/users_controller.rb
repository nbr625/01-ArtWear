...
describe UsersController, type: :controller do
	...
	describe "POST #create" do
		...
		context "with attributes within parameters" do
			it "saves the user in the database" do
				expect{
					post :create, user: build.attributes_for(:user)
		...
		context "with invalid attributes" do
			it "does not save the new user to the database" do
				expect{
					post :create, user: build.attributes_for(:invalid_user)
	...
	describe "PUT update" do
		before :each do
			@user = build(:user, username: "Nicolas Rivers", email: "niberrizbe@gmail.com")
		end

		context "valid attributes" do
			it "located the requested @user" do
				put :update, id: @user, user: build.attributes_for(:user)
				assigns(:user).should eq(@user)
			end

			it "changes @user's attributes" do
				put :update, id: @user,
					user: build.attributes_for(:user, username: "Nicolas Rives", email: "niberrizbe@gmail.com")
			end
		...
		context "invalid attributes" do
			...
			it "located the appropiarte @user" do
				put :update, id: @user, user: build.attributes_for(:invalid_user)
				assigns(:user).should eq(@user)
			end
			...
			it "does not change @user's attributes" do
				...
				put :update, id: @user,
					user: build.attributes_for(:user, username: "Nicolas Rives", email: nil)
				@user.reload
