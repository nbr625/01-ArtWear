...
describe OrderItemsController do
	...
	describe "POST #create" do
		...
		context "with attributes within parameters" do
			it "saves the order_item in the database" do
				expect{
					post :create, order_item: Factory.attributes_for(:order_item)
		...
		context "with invalid attributes" do
			it "does not save the new order_item to the database" do
				expect{
					post :create, order_item: Factory.attributes_for(:invalid_order_item)
	...
	describe "PUT update" do
		...
		before :each do
			@order_item = Factory(:order_item, quantity: 2, unit_price: 19.99)
		end

		context "valid attributes" do
			it "located the requested @order_item" do
				put :update, id: @order_item, order_item: Factory.attributes_for(:order_item)
				assigns(:order_item).should eq(@order_item)
			end

			it "changes @order_item's attributes" do
				put :update, id: @order_item,
					order_item: Factory.attributes_for(:order_item, quantity: 2, unit_price: 19.99)
				end
			end
		...
		context "invalid attributes" do
			...
			it "located the appropiarte @order_item" do
				put :update, id: @order_item, order_item: Factory.attributes_for(:invalid_order_item)
				assigns(:order_item).should eq(@order_item)
			end
			...
			it "does not change @order_item's attributes" do
				...
				put :update, id: @order_item,
					order_item: Factory.attributes_for(:order_item, quantity: 2, unit_price: nil)
				@order_item.reload
