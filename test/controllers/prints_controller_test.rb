...
class PrintsControllerTest < ActionController::TestCase
  ...
  test "should create print" do
    assert_difference('Print.count') do
      post :create, print: { category: @print.category, description: @print.description, name: @print.name, pledge: @print.pledge, rating: @print.rating }
    end
  ...
  test "should update print" do
    patch :update, id: @print, print: { category: @print.category, description: @print.description, name: @print.name, pledge: @print.pledge, rating: @print.rating }
    assert_redirected_to print_path(assigns(:print))
  end
